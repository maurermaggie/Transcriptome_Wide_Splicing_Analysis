...
ggsave(filename=output_var_explained, plot=linear_variance_explained_junction,  limitsize = FALSE, units = "in")
...
ggsave(filename=Specific_Metrics_Var_Explained_fp, plot=linear_variance_explained_junctions,  limitsize = FALSE, units = "in")
