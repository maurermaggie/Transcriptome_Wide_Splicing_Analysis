...
files_jaccard <- read_csv("/home/maurertm/smontgom/shared/UDN/Analysis/Transcriptome_Wide_Splicing_Analysis/FRASER_snakemake/output/FRASER2_no_sibs/FRASER_input.csv")
...
colnames(MIG_count) <- c("sampleID", "no_MIGs_theta_juncs")
...
colnames(MIG_count_jaccard) <- c("sampleID", "no_MIGs_jaccard_juncs")
all_count <- left_join(all_count, MIG_count_jaccard)

write_csv(all_count, "/home/maurertm/smontgom/shared/UDN/Analysis/FRASER/inputs/metadata/counts_filtered_with_sibs.csv")
