...
forest_plot_function <- function(outlier_genes, filtered_gene_list) {
            ...
            values <- c("Haploinsufficient", OL, DD, "OMIM", CRISPR_Tag, "Recessive", "Dominant", LoF_Tag)
...
p_values <- c(1.305111e-01, 3.135457e-03, 1.510683e-12, 6.437797e-39, 7.153273e-01, 5.673406e-02, 2.350456e-02, 4.226780e-03)
