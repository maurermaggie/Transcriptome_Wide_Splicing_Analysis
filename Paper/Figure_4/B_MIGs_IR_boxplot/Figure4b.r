...
joined_RNU6ATAC$MS <- "RNU6ATAC-opathies"
...
MIG_boxplot
ggsave(filename="/home/maurertm/smontgom/shared/UDN/Analysis/Transcriptome_Wide_Splicing_Analysis/Paper/Figure_4/B_MIGs_IR_boxplot/MIG_boxplot_RNU6ATAC.pdf", plot=MIG_boxplot,  limitsize = FALSE, units = "in")
